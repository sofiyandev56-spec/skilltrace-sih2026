...
import { getTranslation } from './languageEngine.js'
...
export default function ChatbotPanel({
  ...
  const [messages, setMessages] = useState(() => [
    {
      ...
      text:
        role === 'ministry'
          ? "Namaste! I am your **AI Admin Analytics Assistant** for SkillTrace. Ask me to summarise the dashboard, explain graphs, rank training centres, or search trainee records by ID."
          : "Namaste! I am your **AI Skill & Support Assistant**. Ask me about your skill gaps, training advice, assessment results, or navigating the platform.",
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        {
          id: `bot-err-${Date.now()}`,
          sender: 'bot',
          text: getTranslation(userLang, 'fallback', '1800-XXX-XXXX'),
          timestamp: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }),
        },
      ])
    } finally {
  ...
  const botTitle =
    role === 'ministry'
      ? getTranslation(userLang, 'adminTitle')
      : getTranslation(userLang, 'clientTitle')
    ...
    >
      ...
      <div className="st-chatbot-header">
        <div className="st-chatbot-header__top">
          <div className="st-chatbot-header__title-group">
            ...
            <div>
              ...
              <span className="st-chatbot-header__sub">
                ...
                {getTranslation(userLang, 'online')} · SkillTrace Intelligence
              </span>
            </div>
          </div>
          <div className="st-chatbot-header__actions">
            <button
              ...
              onClick={handleClear}
              title={getTranslation(userLang, 'clear')}
              aria-label={getTranslation(userLang, 'clear')}
            >
        ...
        <div className="st-chatbot-header__meta">
          <span className="st-chatbot-role-chip">
            {role === 'ministry' ? 'Admin Mode' : 'Client Mode'}
          </span>
          <div className="st-chatbot-lang-select" role="radiogroup" aria-label="Language Selector">
      ...
      <div className="st-chatbot-body" role="log" aria-live="polite">
        {messages.map((m) => (
          <div key={m.id} className={`st-msg st-msg--${m.sender}`}>
            ...
            <div>
              <div className="st-msg__bubble">{renderMarkdown(m.text)}</div>
        ...
        {isTyping && (
          <div className="st-msg st-msg--bot">
            ...
            <div className="st-typing" aria-label={getTranslation(userLang, 'thinking')}>
      ...
      <div className="st-chatbot-footer">
        ...
        <input
          ...
          placeholder={getTranslation(userLang, 'typePlaceholder')}
        ...
        >
          <span>{getTranslation(userLang, 'send')}</span>
