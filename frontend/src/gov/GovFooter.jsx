...
export default function GovFooter() {
  ...
  return (
    <footer className="gov-footer" role="contentinfo">
      ...
      {/* Blended Sovereign Tricolor Horizon Band — 100% Integrated with Footer, Zero Sliding Motion */}
      <div className="gov-footer__bottom-band">
        <div className="gov-footer__center-strip">
          <span className="gov-footer__center-text">
            {hi
              ? '🇮🇳 सत्यमेव जयते | कौशल भारत, कुशल भारत — कौशल विकास एवं उद्यमशीलता मंत्रालय, भारत सरकार'
              : '🇮🇳 Satyameva Jayate | Skill India Mission — Ministry of Skill Development & Entrepreneurship, Government of India'}
          </span>
        </div>
        <div className="gov-footer__tricolor-line" aria-hidden="true">
          <span className="gov-footer__tricolor-part gov-footer__tricolor-part--saffron" />
          <span className="gov-footer__tricolor-part gov-footer__tricolor-part--white" />
          <span className="gov-footer__tricolor-part gov-footer__tricolor-part--green" />
        </div>
      </div>
    </footer>
  )
