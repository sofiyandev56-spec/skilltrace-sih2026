...
export default function GovNav({ counts = { disputes: 0, followup: 0 }, onResetDemo }) {
  ...
  const employerItems = [
    {
      path: '/employer',
      labelEn: 'Employer Verification Roster',
      labelHi: 'नियोक्ता सत्यापन सूची',
      badge: null,
    },
    {
      path: '/check-in',
  ...
  let navItems = govItems
  if (role === 'employer') navItems = employerItems
  else if (role === 'client') navItems = clientItems
